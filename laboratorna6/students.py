...
class Student():
    def __init__(self,student_name,settings):
        ...
        self.individual_task_tries = 0
        self.last_indindividual_task_try_mark = 0
    ...
    def marks_for_lab(self):
        ...
        self.lab_1_mark = input('mark for the last try lab 1: ')
        self.total_course_mark += int(self.lab_1_mark)

        self.lab_2_tries = input('num of lab 2 tries: ')
        self.lab_2_mark = input('mark for the last try lab 2: ')
        self.total_course_mark += int(self.lab_2_mark)

        self.lab_3_tries = input('num of lab 3 tries: ')
        self.lab_3_mark = input('mark for the last try lab 3: ')
        self.total_course_mark += int(self.lab_3_mark)
        
        self.lab_4_tries = input('num of lab 4 tries: ')
        self.lab_4_mark = input('mark for the last try lab 4: ')
        self.total_course_mark += int(self.lab_4_mark)

        self.lab_5_tries = input('num of lab 5 tries: ')
        self.lab_5_mark = input('mark for the last try lab 5: ')
        self.total_course_mark += int(self.lab_5_mark)


    def mark_for_individual_task(self):
        self.individual_task_tries = input('num of individual task tries: ')
        self.individual_task_mark = input('mark for individual task: ')
        self.total_course_mark += int(self.individual_task_mark)
...
student = Student('Olexandr', settings)
student.marks_for_lab()
student.mark_for_individual_task()
student.report()